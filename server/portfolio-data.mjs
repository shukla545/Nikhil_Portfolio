export const profile = {
  ...
  summary:
    "B.E. Information Technology student at TCET, Mumbai. Builds MERN platforms, RAG systems, LangChain/OpenAI applications, embeddings workflows, vector search, and agentic AI product experiences. Grand Finalist at MumbaiHacks 2025 and 2nd place winner at AMUHACK National Level Hackathon."
};
...
export function planActions(message) {
...
export function fallbackAnswer(message, context) {
  const text = message.toLowerCase();
  ...
  if (text.includes("contact") || text.includes("touch") || text.includes("meeting")) {
    return "You can contact Nikhil at nikhilshukla8652@gmail.com or through his LinkedIn profile. The portfolio contact panel can prefill a message and show email and meeting actions.";
  }
